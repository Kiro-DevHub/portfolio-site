...
export const services: Service[] = [
  {
    ...
    includes: ["дизайн", "адаптив", "SEO-база", "форма заявок", "деплой"],
  },
  {
    ...
    includes: ["сценарии", "БД", "админ-уведомления", "хостинг"],
  },
  {
    ...
    includes: ["схема", "связи", "индексы", "миграции"],
  },
  {
    ...
    includes: ["всё вышеперечисленное", "интеграции"],
    featured: true,
  },
];
