...
export type CaseContent = {
  ...
  repoUrl?: string;
  /**
   * 'mobile' — скрины сняты с телефона (Mini App/приложение): хиро и галерея
   * держат компактную рамку по естественным пропорциям скрина вместо
   * растяжения на всю ширину десктопного BrowserFrame. По умолчанию 'desktop'.
   */
